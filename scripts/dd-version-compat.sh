...
#   ./scripts/dd-version-compat.sh 3.2.300 3.2.0      # Check specific versions
#   ./scripts/dd-version-compat.sh --test 3.2.300      # Test a specific version

DEFAULT_VERSIONS=("3.2.300")
RUN_TESTS=false
VERSIONS=()
