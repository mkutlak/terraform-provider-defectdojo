...
subcategory: ""
description: |-
  DefectDojo Engagement data source. You can specify either the id or the name to look up the Engagement.
---
...
# Or lookup by ID
# data "defectdojo_engagement" "by_id" {
#   id = "1"
# }
```
...
- `name` (String) Name of the Engagement. Specify either id or name.
